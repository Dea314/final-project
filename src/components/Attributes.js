...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const rows = [
    ...
    createData('location', 'string', 'Location/s that the Character appeard through out the Games'),
    ...
    createData('resistance','string', 'Which components they are resistant to in a battle'),
